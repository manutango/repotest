...
ALTER PROC modelo_capsa.SP_FT_PARADAS_OIL_GAS_PROD AS

BEGIN


/*****************************************************************************************************************/
/** SP que carga la tabla FT_PARADAS_OIL_GAS con datos de Producción provenientes de SGO CIV 				    **/
/*****************************************************************************************************************/

--Borro proceso de PARADAS Producción
DELETE DW.modelo_capsa.FT_PARADAS_OIL_GAS
WHERE sk_proceso = 41 ;



/* Inserción de datos de origen SGO_PARADAS_PRODUCCIÓN */
...
select 
	...
	F.afecta_controles,
	F.duracion,
	F.perdida_localizada_bruta as prod_perdida_localizada_bruta, 
	F.perdida_localizada_sn as prod_perdida_localizada_sn, 
	F.perdida_localizada_neta as prod_perdida_localizada_neta, 
	F.perdida_localizada_gas as prod_perdida_localizada_gas, 
	NULL perdida_localizada, 
	NULL perdida_neta_asociada,	
	F.id_pozo

...
/*****************************************************************************************************************/
/** SP que carga la tabla de STO para datos de Inyección provenientes de SGO CIV 								**/
/*****************************************************************************************************************/
...
/* Inserción de datos de origen BISGO_INYECCIONCIV */
...
id_area_sgo, id_campaña, id_proceso, inyeccion_civ,	inyeccion_civ_tei, inyeccion_civ_cal, tei, pronostico_inyeccion, pronostico_efectivo_mes, presion_civ, 
...
--top 100
	...
	'CARGA_REAL_INYECCIÓN' as id_proceso,		

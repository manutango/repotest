...
/*****************************************************************************************************************/
/** SP que carga la tabla de STO para datos de Energía Ficticio Presupuesto y Repro     						**/
/*****************************************************************************************************************/
...
/* Inserción de datos de Presupuesto FICTICIO - SGP_CIERRE_DIARIO_CT */
...
/* Inserción de datos de Presupuesto FICTICIO - SGP_CIERRE_DIARIO_CT_PLANTA */
INSERT INTO DW.STO.FT_PRODUCCION_ENERGIA_PP_FICTICIO
(id_escenario_version, id_fecha, id_periodo, id_unidad_negocio, id_empresa, id_grupo_empresa, id_ubicacion, id_centro, id_activo, id_proyecto, id_campaña, 
...
/* Inserción de datos de Repro FICTICIO - SGP_CIERRE_DIARIO_CT */
...
/* Inserción de datos de Repro FICTICIO - SGP_CIERRE_DIARIO_CT_PLANTA */
INSERT INTO DW.STO.FT_PRODUCCION_ENERGIA_REPRO_FICTICIO
(id_escenario_version, id_fecha, id_periodo, id_unidad_negocio, id_empresa, id_grupo_empresa, id_ubicacion, id_centro, id_activo, id_proyecto, id_campaña, 
id_unidad_generadora_ct, id_proceso, consumo_yacimiento_MWh, consumo_generales_ct_MWh, perdidas_linea_MWh, energia_neta_MWh, potencia_neta_MW)
SELECT 	

...
--Query Carga Real v1 STAGING CAPEX
...
from DW.STI.[PVW_FT_R55_CAPEX19-20] pfrc
where trim([cuenta contable]) = '20.142.000.041.101.100'
;
...
select top 1000 * from DW.STI.[PVW_FT_R55_CAPEX19-20]
where trim([Codigo de Art]) = 'TOADVSADES014'
...
from DW.STO.[PVW_FT_R55_CAPEX19-20]
where [ Moneda Local ] = ' -   ' 
...
from DW.STO.[PVW_FT_R55_CAPEX19-20]
WHERE trim([Fecha de Contabilizacion]) = '43851'
...
/*
No tomar de col cuenta cont del archivo, tomar desambiguación
*/

select top 100 *
from [STI].[Tareas_Mantenimiento]

...
ALTER PROC [STO].[SP_FT_PARADAS_OIL_GAS_INY] AS

BEGIN


/*****************************************************************************************************************/
/** SP que carga la tabla de STO para datos de PARADAS INYECCIÓN provenientes de SGO CIV 					    **/
/*****************************************************************************************************************/


/* Limpieza de tabla de STO */
TRUNCATE TABLE DW.STO.FT_PARADAS_OIL_GAS_INY;


/* Inserción de datos de origen SGO_PARADAS_PRODUCCION */
INSERT INTO DW.STO.FT_PARADAS_OIL_GAS_INY
(
...
id_area_sgo, id_campaña, id_proceso, id_evento, duracion, perdida_localizada, perdida_neta_asociada, 
...
--top 100
	...
	'CARGA_REAL_PARADAS_INYECCIÓN' as id_proceso,
	...
	descripcion_causa,
	PO.ID_POZO
FROM DW.staging_in.SGO_PARADAS_INYECCION A

...
/*****************************************************************************************************************/
/** SP que carga la tabla de STO para datos de CONTROLES INYECCIÓN provenientes de SGO CIV 					**/
/*****************************************************************************************************************/
...
id_campaña, id_proceso, id_control, caudal_agua_inyectada, capitulo_iv, neta_asociada, dias_sin_control, diferencia_control_anterior, diferencia_agua_inyectada_programada, 
...
--top 100
	...
	'CARGA_REAL_CONTROLES_INYECCIÓN' as id_proceso,
